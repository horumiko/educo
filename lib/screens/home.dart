          ...
          children: [
            Expanded(child: 
              Column(
                ...
                children: [
                  Text('${user?.email}', style: TextStyle(color: labelColor, fontSize: 14,),),
                  SizedBox(height: 5,),
          ...
          (index) => FeatureItem(
            onTap: (){
              Navigator.push(context, 
                MaterialPageRoute(builder: (context) => CourseDetailPage(data: features[index],))
              );
            },
            data: features[index]
          )
          ...
          children: List.generate(recommends.length, (index) => 
            Padding(
              ...
              child: RecommendItem(
                ...
                onTap: (){
                  Navigator.push(context, 
                    MaterialPageRoute(builder: (context) => CourseDetailPage(data: recommends[index],))
                  );
                },
              )
            ) 
